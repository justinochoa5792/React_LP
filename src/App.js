...
function App() {
  return (
    <div className="min-h-screen flex flex-col text-white">
      <main className="container mx-auto px-6 pt16 flex-1 text-center">
        ...
        <form
          action="https://www.getrevue.co/profile/just-och92/add_subscriber"
          method="post"
          id="revue-form"
          name="revue-form"
          target="_blank"
      ...
      <footer className="container mx-auto p-6 flex flex-col md:flex-row items-center justify-between">
        <p> Built with 💖 by Justin Ochoa</p>
